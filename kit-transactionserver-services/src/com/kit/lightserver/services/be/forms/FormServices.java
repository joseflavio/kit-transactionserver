...
public final class FormServices {
    ...
    public SimpleServiceResponse<FormsParaEnviarCTX> retrieveCurrentForms(final String ktClientUserId, final boolean retrieveNaoRecebidos) {
        ...
        final Chronometer c1 = new Chronometer(this, "retrieveCurrentForms");
        c1.start();
        ...
        FormServices.LOGGER.info("Time to execute the service. chronometer={}", c1.toString(conhecimentosList.size()));
