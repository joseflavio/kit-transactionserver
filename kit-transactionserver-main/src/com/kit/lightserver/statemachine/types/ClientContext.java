...
public final class ClientContext {
    ...
    public ClientContext(final String ktClientId, final AuthenticationServiceResponse authenticationResponse, final boolean authenticated,
    ...
    public ClientContext(final String clientUserId, final AuthenticationServiceResponse authenticationResponse) {
